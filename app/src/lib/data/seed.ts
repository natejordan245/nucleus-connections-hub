...
export const baselinePushes: AffinityPushDTO[] = [
  {
    ...
    status: "pushed",
    affinityOrganizationId: 100_001,
    affinityPersonId: 200_001,
    affinityListEntryId: 300_001,
    affinityListId: 8421,
    affinityUrl: "https://app.affinity.co/lists/8421/list_entries/300001",
    pipelineStage: "intro_queued",
    syncState: "synced",
    syncError: null,
    apiCalls: [
      { method: "POST", path: "/organizations", status: 201, durationMs: 41, at: "2026-05-07T18:02:00.120Z" },
      { method: "POST", path: "/persons", status: 201, durationMs: 38, at: "2026-05-07T18:02:00.180Z" },
      { method: "POST", path: "/lists/8421/list-entries", status: 201, durationMs: 33, at: "2026-05-07T18:02:00.230Z" },
      { method: "POST", path: "/lists/8422/list-entries", status: 201, durationMs: 31, at: "2026-05-07T18:02:00.270Z" },
      { method: "PUT", path: "/field-values", status: 200, durationMs: 22, at: "2026-05-07T18:02:00.300Z" },
      { method: "PUT", path: "/field-values", status: 200, durationMs: 21, at: "2026-05-07T18:02:00.325Z" },
      { method: "PUT", path: "/field-values", status: 200, durationMs: 19, at: "2026-05-07T18:02:00.350Z" },
      { method: "PUT", path: "/field-values", status: 200, durationMs: 20, at: "2026-05-07T18:02:00.375Z" },
      { method: "PUT", path: "/field-values", status: 200, durationMs: 24, at: "2026-05-07T18:02:00.400Z" },
    ],
    fieldValues: [
      { label: "Match score", value: "84%" },
      { label: "Reason", value: "84% match. Priya Patel ↔ Lumen Bio (Pre-seed, Life sciences)." },
      { label: "Pipeline", value: "Intro queued" },
    ],
  },
];

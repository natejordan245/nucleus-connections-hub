    ...
    <main className="mx-auto w-full max-w-5xl px-8 py-10">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex h-10 items-center gap-2 rounded-full bg-orange-500 px-5 text-sm font-semibold text-white shadow-[0_8px_24px_-8px_rgba(255,114,39,0.55)] transition hover:bg-orange-600 disabled:opacity-60"
        >

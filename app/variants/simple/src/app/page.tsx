      ...
      <main className="mx-auto grid w-full max-w-6xl flex-1 grid-cols-1 items-center gap-12 px-8 pb-12 pt-8 md:grid-cols-[minmax(0,1fr)_minmax(0,520px)]">
        <div>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            <Link
              href={ctaHref}
              className="group inline-flex items-center gap-3 rounded-full bg-orange-500 px-6 py-3 text-sm font-semibold text-white shadow-[0_8px_24px_-8px_rgba(37,99,235,0.55)] transition hover:bg-orange-600 hover:shadow-[0_10px_30px_-8px_rgba(37,99,235,0.7)]"
            >
              {ctaLabel}
